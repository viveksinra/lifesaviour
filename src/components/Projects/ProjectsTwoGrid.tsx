...
const ProjectsTwoGrid: React.FC = () => {
  return (
    <>
          ...
          <div className="row">
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">Development</Link>
                  </span>
                  <h3>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">Web Design</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">eCommerce</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">React</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">Angular</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">Graphic Design</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">Bootstrap</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">App Development</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="work-card">
                ...
                <div className="content">
                  <span>
                    <Link href="/projects/details">Marketing</Link>
                  </span>
                  <h3>
                    <Link href="/projects/details">
